...
TESTS = [
    # 0
    {"arg": [[5, 2, 3, 1, 0, 8, 15], [3, 4, 6]], "hint": 8},
    # 1
    {"arg": [[-5, -2, -3, -1, 0, -8, -15], [3, 4, 6]], "hint": -1},
    # 2
    {"arg": [[1, 2, 3, 4, 5, 6, 7], [1, 3, 7]], "hint": 7},
    # 3
    {
        "arg": [
            [
    ...
    {
        "arg": [
            [34, 12, 22, 11, 0, -5, 17, 22, 33, 44, 45, 21, 13, 14, 15],
            [2, 4, 5, 8, 9],
        ],
        "hint": 33,
    },
    ...
    {
        "arg": [
            [MY_random() % 10**6 for i in range(1023)],
            [(MY_random() % 1000) + 1 for ii in range(100)],
        ],
        "hint": 995353,
    },
    # 6
    {
        "arg": [
            [MY_random() % (10**7) for i in range(2047)],
            [(MY_random() % 2000) + 1 for ii in range(500)],
        ],
        "hint": 9998812,
    },
]
...
def runtests(f):
    internal_runtests(
        printarg, printhint, printsol, check, Converted(TESTS), f, ALLOWED_TIME
    )

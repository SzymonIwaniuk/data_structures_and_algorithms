...
def build_adjacency_list(G: List[Tuple[int, int, int]], n: int) -> List[List[Tuple[int, int]]]:
...
def armstrong(B: List[Tuple[int, int, int]], G:List[Tuple[int, int, int]], s: int, t: int) -> int:
